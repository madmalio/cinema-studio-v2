          ...
          >
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    placeholder="Describe the HERO LOOK. This image will be the reference for all future scenes."
                  />
                </div>
              </div>
            ...
            <div className="p-6 border-t border-zinc-800 bg-zinc-900/30 flex-shrink-0">
              ...
              >
                {isGenerating ? (
                  <>
                    <Loader2 className="mr-2 animate-spin" /> DEVELOPING HERO...
                  </>
                ) : (
                  <>
                    <Dice5 size={18} className="mr-2" /> GENERATE HERO
                  </>
                )}
              </Button>
            </div>
      ...
      <div className="flex-1 bg-black flex items-center justify-center relative bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-zinc-900/50 to-black overflow-hidden">
        ...
        {activeTab === "generate" && (
          <div className="absolute top-4 right-4 flex gap-2 z-10">
            ...
            >
              <Save size={14} className="mr-2" /> Establish Identity
            </Button>
          </div>
        )}
